    ...
    return (
      <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
        <div className="mb-10 relative backdrop-blur-sm border border-border p-6">
          <CornerElements />
          <div className="flex items-center justify-center h-24">
            <span className="text-muted-foreground font-mono">Please sign in to view your profile</span>
          </div>
        </div>
      </section>
    );
    ...
    <section className="relative z-10 pt-12 pb-32 flex-grow container mx-auto px-4">
      ...
      {allPlans && allPlans?.length > 0 ? (
        ...
        <div className="relative backdrop-blur-sm border border-border p-6">
          ...
          <div className="flex items-center justify-center h-24">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary"></div>
            <span className="ml-2 text-muted-foreground font-mono">Loading fitness plans...</span>
          </div>
        </div>
      ) : (
        <NoFitnessPlan />
